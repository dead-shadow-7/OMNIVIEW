...
const BRIEF_HEADER_HTML = `
  <div class="brief-header">
    ...
    <span class="brief-title">Summary</span>
    <span class="brief-pill">AI · Model-generated</span>
  </div>`;
...
function showBriefLoading() {
  ...
  card.innerHTML = `
    ...
    <div class="brief-footer">Synthesizing latest coverage…</div>
  `;
}
...
function renderBrief(text) {
  ...
  card.innerHTML = `
    ...
    <div class="brief-footer">AI-generated summary${windowSuffix}</div>
  `;
}
